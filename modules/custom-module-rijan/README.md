...
1. Copy the folder `examples/module-templates/custom-module-rijan` to `modules/custom-module-rijan`
2. Open a terminal in the folder `modules/custom-module-rijan` and type `yarn && yarn build`
...
```js
{
  ...
  "modules": [
    ...
    {
      "location": "MODULES_ROOT/custom-module-rijan",
      "enabled": true
    },
}
```
