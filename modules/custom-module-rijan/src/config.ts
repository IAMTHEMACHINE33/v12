 ...
 * For example, `data/bots/MY_BOT/config/custom-module-rijan.json` will be used by MY_BOT, while `data/global/config/custom-module-rijan.json` will be used for all others
 */
